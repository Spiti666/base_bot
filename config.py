...
PRODUCTION_PROFILE_REGISTRY: dict[str, dict[str, object]] = {'BTCUSDT': {'strategy_name': 'frama_cross',
 ...
 'ETHUSDT': {'strategy_name': 'dual_thrust',
             'interval': '5m',
             'strategy_params': {'dual_thrust_k1': 0.9, 'dual_thrust_k2': 0.5, 'dual_thrust_period': 55.0},
             'default_leverage': 25,
             'stop_loss_pct': 8.0,
             'take_profit_pct': 5.0,
             'breakeven_activation_pct': 3.5,
 ...
 'ADAUSDT': {'strategy_name': 'frama_cross',
             'interval': '15m',
 ...
 '1000SHIBUSDT': {'strategy_name': 'ema_cross_volume',
                  'interval': '15m',
                  'strategy_params': {'ema_fast_period': 11.0,
 ...
 'BNBUSDT': {'strategy_name': 'frama_cross',
             ...
             'trailing_activation_pct': 3.0,
             'trailing_distance_pct': 0.3},
 'AVAXUSDT': {'strategy_name': 'frama_cross',
              'interval': '15m',
              'strategy_params': {'frama_fast_period': 12.0,
 ...
 'NEARUSDT': {'strategy_name': 'ema_cross_volume',
              ...
              'trailing_activation_pct': 3.0,
              'trailing_distance_pct': 0.3},
 'DOTUSDT': {'strategy_name': 'ema_cross_volume',
             'interval': '1h',
             'strategy_params': {'ema_fast_period': 9.0,
                                 'ema_slow_period': 180.0,
                                 'volume_multiplier': 2.25,
 ...
 'ARBUSDT': {'strategy_name': 'dual_thrust',
             'interval': '15m',
             'strategy_params': {'dual_thrust_k1': 0.2,
                                 'dual_thrust_k2': 0.3,
 ...
 'SUIUSDT': {'strategy_name': 'dual_thrust',
             'interval': '1h',
             'strategy_params': {'dual_thrust_k1': 0.64,
                                 'dual_thrust_k2': 0.3,
                                 'dual_thrust_period': 55.0,
                                 'chandelier_period': 22.0,
                                 'chandelier_multiplier': 3.0},
