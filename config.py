...
PRODUCTION_PROFILE_REGISTRY: dict[str, dict[str, object]] = {'BTCUSDT': {'strategy_name': 'frama_cross',
             'interval': '15m',
             'strategy_params': {'frama_fast_period': 13.0, 'frama_slow_period': 200.0, 'volume_multiplier': 2.5},
             'default_leverage': 25,
             'stop_loss_pct': 3.0,
             'take_profit_pct': 7.5,
 ...
 'XRPUSDT': {'strategy_name': 'ema_band_rejection',
             ...
             'breakeven_activation_pct': 2.0,
             'breakeven_buffer_pct': 0.2},
 'ADAUSDT': {'strategy_name': 'ema_band_rejection',
             'interval': '1h',
             'strategy_params': {'ema_fast': 5.0,
                                 'ema_mid': 10.0,
                                 'ema_slow': 20.0,
 ...
 'DOGEUSDT': {'strategy_name': 'dual_thrust',
              ...
              'breakeven_activation_pct': 3.5,
              'breakeven_buffer_pct': 0.2},
 '1000PEPEUSDT': {'strategy_name': 'ema_band_rejection',
                  'interval': '1h',
                  'strategy_params': {'ema_fast': 5.0,
                                      'ema_mid': 10.0,
                                      'ema_slow': 20.0,
 ...
 'AVAXUSDT': {'strategy_name': 'dual_thrust',
              ...
              'breakeven_activation_pct': 5.0,
              'breakeven_buffer_pct': 0.2},
 'NEARUSDT': {'strategy_name': 'ema_band_rejection',
              'interval': '1h',
              'strategy_params': {'ema_fast': 5.0,
                                  'ema_mid': 10.0,
                                  'ema_slow': 20.0,
 ...
 'DOTUSDT': {'strategy_name': 'dual_thrust',
             'interval': '5m',
             'strategy_params': {'dual_thrust_k1': 0.2, 'dual_thrust_k2': 0.2, 'dual_thrust_period': 400.0},
             'default_leverage': 25,
             'stop_loss_pct': 0.5,
 ...
 'LTCUSDT': {'strategy_name': 'frama_cross',
             'interval': '5m',
             'strategy_params': {'frama_fast_period': 21.0, 'frama_slow_period': 100.0, 'volume_multiplier': 2.0},
             'default_leverage': 25,
             'stop_loss_pct': 1.5,
             'take_profit_pct': 5.0,
             'trailing_activation_pct': 5.0,
             ...
             'breakeven_activation_pct': 5.0,
             'breakeven_buffer_pct': 0.2},
 'BCHUSDT': {'strategy_name': 'dual_thrust',
             'interval': '1h',
             'strategy_params': {'dual_thrust_k1': 0.2, 'dual_thrust_k2': 0.3, 'dual_thrust_period': 200.0},
             'default_leverage': 25,
             'stop_loss_pct': 1.5,
             'take_profit_pct': 3.0,
             'trailing_activation_pct': 5.0,
 ...
 'TRXUSDT': {'strategy_name': 'dual_thrust',
             'interval': '1h',
             'strategy_params': {'dual_thrust_k1': 0.2, 'dual_thrust_k2': 0.5, 'dual_thrust_period': 100.0},
             'default_leverage': 25,
             'stop_loss_pct': 0.5,
             'take_profit_pct': 3.0,
             'trailing_activation_pct': 3.0,
 ...
 'FILUSDT': {'strategy_name': 'ema_band_rejection',
             ...
             'trailing_activation_pct': 2.0,
             'trailing_distance_pct': 0.1},
 'AAVEUSDT': {'strategy_name': 'ema_cross_volume',
              'interval': '15m',
              'strategy_params': {'ema_fast_period': 9.0, 'ema_slow_period': 300.0, 'volume_multiplier': 3.0},
              'default_leverage': 25,
              'stop_loss_pct': 1.0,
              'take_profit_pct': 10.0,
              'trailing_activation_pct': 3.0,
